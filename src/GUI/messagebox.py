...
class MessageBox(Window): # Basically a hardcoded window
    def __init__(self, pos, width, height, color, message, input):
        ...
        self.message.position = self.center - sf.Vector2(text_width/2, text_height/2) # Center text in message box
        ...
        self.button.position = sf.Vector2(self.center.x, height-52) - sf.Vector2(button_width/2, button_height/2) # Center button in message box
